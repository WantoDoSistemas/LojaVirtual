...
<head>
<title>Produtos Visitados</title>
<style>
				...
				<tr>
					<td colspan="2">  <!--<img src="../images/slogan.jpg" border="0" width="800" height="110" alt=""> -->
						<div id="divLogo" width="800" height="110">
							<br>
							<span id="titulo"><center>Produtos Visitados</center></span>
						</div>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
						<form>
							<table id=tabForm>	
								<tr>									
									<td>Cliente</td> <td><input type="text" id="txtCliente" name="txtCliente" size="105px"> </td>						
								</tr>
								<tr>
									<td>Produto(s)</td> <td><a href="frmProdutoPromocao.php" target="_blank"><img src="../images/add_list.png"></a></td>
								</tr>
								<tr>									
									<td>Data Visita de </td> <td><input type="text" id="txtDtDe" name="txtDtDe"> </td>								
								</tr>
								<tr>
									<td>Até </td> <td><input type="text" id="txtDtAte" name="txtDtAte"> </td>
