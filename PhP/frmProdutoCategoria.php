				...
				<tr>
					<td colspan="2">  <!--<img src="../images/slogan.jpg" border="0" width="800" height="110" alt=""> -->
						<div id="divLogo" width="800" height="110">
							<br>
							<span id="titulo"><center>Produto Categoria</center></span>
						</div>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
						<form>
							<table id=tabForm>																
								<tr>
									<td>Categoria</td> <td><input type="text" id="txtCategoria" name="txtCategoria" size="105px"> <img src="../images/find.ico"></td>
								</tr>
							</table>
						</form>
					</td>
					...
					<td colspan="2">
						<table id="box-table-b">
							<tr>
								...
								<th scope="col" style="width:650px;">Categoria</th>									
								<th scope="col"></th>								
							</tr>
							<tr>
								<td>0001</td>
								<td style="text-align:left;">Sala de Jantar</td>
								<td><input type="checkbox" id="chkCategoria_1" value="001"></td>									
							</tr>
							
							<tr>
								<td>0002</td>
								<td style="text-align:left;">Cozinha</td>
								<td><input type="checkbox" id="chkCategoria_2" value="002"></td>									
							</tr>							
						</table>
					</td>
				</tr>
