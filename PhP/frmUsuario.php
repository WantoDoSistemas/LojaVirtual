				...
				<tr>
					<td colspan="2">  <!--<img src="../images/slogan.jpg" border="0" width="800" height="110" alt=""> -->
						<div id="divLogo" width="800" height="110">
							<br>
							<span id="titulo"><center>Cadastro de Usuário</center></span>
						</div>
					</td>
				</tr>
					...
					<td colspan="2">
						<form>
							<table id=tabForm>
								...
								<tr>
									<td>Senha</td> <td><input type="password" id="txtSenha" name="txtSenha" size="40px"></td>
								<tr>
								
								<tr>
									<td>Confirmar senha</td> <td><input type="password" id="txtConfirmarSenha" name="txtConfirmarSenha" size="40px"></td>
								<tr>
								
								<tr>
									<td>Lembrete senha</td> <td><input type="text" id="txtLembrete" name="txtLembrete" size="40px"></td>
								<tr>
								
								<tr>
									<td>Status</td> <td><input type="checkbox" id="chkStatus" name="chkStatus" value="Ativo"></td>
								<tr>
							</table>
						</form>
					</td>
					...
					<td colspan="2">
						<table id="box-table-b">
							<tr>
								...
								<th scope="col" style="width:230px;">Usuário</th>
							...
							<tr>
								<td>0001</td>
								<td style="text-align: left;">josegsg</td>
								<td>gabriel@email.com.br</td>
								<td>Ativo</td>
